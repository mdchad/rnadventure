  ...
  return (
    ...
    >
      <div className="h-80 relative rounded-3xl overflow-hidden mb-4">
        ...
        />
        <div className="absolute top-4 right-4 bg-[#05E668] text-[#080808] px-4 py-2 rounded-xl font-bold text-[0.9rem]">
          ${price}
        </div>
      </div>
      <div>
        <div className="flex gap-4 text-[#666] text-[0.9rem] mb-4 font-medium">
          <span>{duration}</span>
          <span>•</span>
          <div className="flex items-center gap-1 text-[#080808] font-bold">
            <svg width="14" height="14" viewBox="0 0 24 24" className="fill-[#080808]">
        ...
        <h3
          className="text-xl mb-2 font-bold leading-tight tracking-tight"
